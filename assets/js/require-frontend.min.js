...
;(function(factory) {
    ...
    (function(){
        var scripts = document.scripts,
            ...
            re = /(.*validator(?:\.min)/index/user/register.js)(\?.*(?:local|css|dir)(?:=[\w\-]*)?)?/;
